        ...
        if 'count' not in str(result['data']):
            ...
            for parcel in data['trackings']:
                ...
                if parcel['tag'] == 'InTransit':
                    ...
                    parcel_data['status'] = parcel['subtag_message'] if parcel['subtag_message'] else parcel['tag']

                parcel_data['location'] = parcel['checkpoints'][-1]['location'] if (parcel['checkpoints'][-1] and parcel['checkpoints'][-1]['location']) else 'Unknown'
